...
faq:
  - question: "Where should I look for real estate leads?"
    answer: "Google Maps is the freshest source. Every agent, broker, and team has an active listing there. You can also build lists from industry directories, chamber of commerce listings, and real estate associations. The best leads are always fresh. This month's active professionals, not last year's compiled lists."
  - question: "What's wrong with buying lead lists?"
    answer: "Purchased lead lists are compiled once and go stale fast. By the time you buy them, many email addresses are old, phone numbers have changed, and agents have moved on. You end up chasing outdated contacts and damaging your reputation with bad data."
  - question: "How do I find decision makers in real estate?"
    answer: "Look at the business owner or team leader name on Google Maps listings. For solo agents, the agent name is the decision maker. For teams, look for team leader titles on the Maps listing or their website. For brokerages, find the broker name or check the website for the managing broker or office manager. Higher up in the organization means more buying authority."
  - question: "Can I reach out to agents I don't know?"
    answer: "Absolutely. Real estate is built on relationships and networks. Agents are used to outreach. The key is being specific: mention something about their business from Google Maps reviews, mention a recent listing, or talk about how you can help them. Personalized outreach works."
  - question: "Is cold email effective for real estate leads?"
    answer: "Yes, when done right. Real estate professionals check email regularly and are open to partnership opportunities, training, and services. Keep it short, be specific, and focus on value. Agents who are actively listing (20+ reviews with recent activity) are most responsive."
  - question: "How many real estate leads should I expect?"
...
[Real estate lead generation tools](/real-estate-agent-leads) automate the sourcing part. You define your search (location + agent type), and the tool:

1. Crawls Google Maps in real time
2. Extracts names, phones, websites, and addresses
3. Verifies email addresses via website crawling and SMTP checks
4. Returns verified contact data for the decision maker
...
1. **Check the email domain.** If the website is dead or a parked page, email discovery will struggle. Verify the domain loads and looks legitimate.
2. **Run SMTP checks.** A tool that verifies email addresses before you send saves your domain reputation. Sending to invalid addresses damages your sender score fast.
3. **Note the gatekeeping reality.** If the main phone number routes to a call center with no path to a decision maker, adjust your expectations. You might still sell, but through operations channels instead of the decision maker's inbox.
...
[WebLeads](/real-estate-agent-leads) is built for the Maps-to-outbox workflow. You search a business type and location, pull fresh Google Maps results, and when a website domain exists, you can add decision maker emails and run SMTP verification before sending.
