...
export const metadata: Metadata = {
  ...
  description: "Verify business emails with SMTP + Catch-All checks. Search Google Maps, enrich from websites. Start free: 2 searches, 200 verifications. From $24/mo.",
