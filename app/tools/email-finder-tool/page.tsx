    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-brand-light to-white py-20 md:py-32">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <Badge className="bg-brand-secondary text-white mb-6 text-md px-4 py-2 animate-in fade-in zoom-in duration-500">
            Free Email Discovery Tool
          </Badge>
          <h1 className="text-5xl md:text-7xl font-bold text-brand-primary leading-tight tracking-tight mb-6">
            Email Finder Tool
          </h1>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="relative bg-[#1e2330] rounded-[2.5rem] p-12 md:p-24 overflow-hidden text-center shadow-2xl">
            {/* Gradient & Shape Background */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#1e2330] via-[#2d3142] to-[#1e2330] opacity-100" />
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-primary/20 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3" />
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full text-blue-100 mb-8 border border-white/10 shadow-sm">
              ...
              <p className="text-lg md:text-xl mb-12 text-blue-100/80 leading-relaxed max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  size="lg"
                  asChild
                  className="bg-brand-primary hover:bg-brand-primary-hover text-white text-lg px-10 py-7 h-auto shadow-xl hover:shadow-2xl transition-all duration-300 rounded-xl border border-white/10"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="text-lg px-10 py-7 h-auto border-2 border-white/20 text-white bg-transparent hover:bg-white/10 hover:border-white/40 transition-all rounded-xl"
                >
...
/>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          {/* How It Works */}
          <div className="bg-brand-light/30 rounded-3xl p-8 md:p-12 border border-brand-primary/5">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 border border-gray-100 hover:border-brand-primary/20 transition-colors">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <Zap className="h-10 w-10 text-brand-accent mb-6" />
              <h3 className="text-xl font-bold text-brand-secondary mb-3">Real-Time Speed</h3>
              <p className="text-gray-600">Get results instantly. No waiting for stale databases to update.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <Shield className="h-10 w-10 text-brand-primary mb-6" />
              <h3 className="text-xl font-bold text-brand-secondary mb-3">Verified Accuracy</h3>
              <p className="text-gray-600">We verify email patterns and domains to ensure high deliverability.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <MousePointer2 className="h-10 w-10 text-green-600 mb-6" />
              <h3 className="text-xl font-bold text-brand-secondary mb-3">Easy to Use</h3>
              <p className="text-gray-600">Just enter a website. We handle the complex scraping and extraction.</p>
            </div>
          </div>
        </div>
      </section>
