...
export const metadata: Metadata = {
  title: "HVAC Leads - Find HVAC Contractors & Decision Makers | WebLeads",
    ...
    <main className="min-h-screen bg-white">
      ...
      <FAQSection
        ...
        faqs={[
          ...
          { question: "Can I export HVAC leads to my CRM?", answer: "Yes. Export is free once you have unlocked leads. Download as CSV and import into Salesforce, HubSpot, Pipedrive, or any system that accepts CSV files." },
          ...pricingLinkedFaqs,
        ]}
      />
      ...
      <section className="py-10 bg-gray-50 border-t border-gray-200">
        <div className="container mx-auto px-4 text-center space-y-3">
          ...
          <p className="text-gray-500 text-sm">
            Also useful:{" "}
            <Link href="/contractor-leads" className="text-brand-primary underline hover:text-brand-primary/80">Contractor leads</Link>
            {" · "}
            ...
            {" · "}
            <Link href="/lead-generation-software" className="text-brand-primary underline hover:text-brand-primary/80">Lead generation software</Link>
          </p>
        </div>
      </section>
